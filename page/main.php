<div class="container mt-5 mb-5">
     ...
     <div class="row">
          ...
          <!-- Section Image -->
          <div class="col-md-6 col-sm-12">
               <img src="assets/img/spice.jpg" class="img-fluid rounded" alt="image-section">
          </div>
     </div>
     <!-- START: Feature -->
     <div class="row mb-5 mt-5 text-center">
          <div class="col-md-4">
               <div class="card mt-2 shadow-lg" style="border: 0;">
                    <div class="card-title">
                         <div class="card-body">
                              <img src="assets/img/Wifi.svg" class="img-fluid" alt="wifi">
                         </div>
                         <p class="text-capitalize" style="font-size: 16px;">respon cepat</p>
                    </div>
               </div>
          </div>
          <div class="col-md-4">
